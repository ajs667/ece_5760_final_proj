...
module Computer_System_mm_interconnect_1 (
		...
		output wire [1:0]  pio_col_s1_address,                                                       //                                                         pio_col_s1.address
		input  wire [31:0] pio_col_s1_readdata,                                                      //                                                                   .readdata
		output wire [1:0]  pio_collectsingle_s1_address,                                             //                                               pio_collectsingle_s1.address
		input  wire [31:0] pio_collectsingle_s1_readdata,                                            //                                                                   .readdata
		output wire [1:0]  pio_color_s1_address,                                                     //                                                       pio_color_s1.address
		input  wire [31:0] pio_color_s1_readdata,                                                    //                                                                   .readdata
		output wire [1:0]  pio_integral_data_s1_address,                                             //                                               pio_integral_data_s1.address
		input  wire [31:0] pio_integral_data_s1_readdata,                                            //                                                                   .readdata
		output wire [1:0]  pio_row_s1_address,                                                       //                                                         pio_row_s1.address
		input  wire [31:0] pio_row_s1_readdata,                                                      //                                                                   .readdata
		output wire [1:0]  pio_state_s1_address,                                                     //                                                       pio_state_s1.address
		input  wire [31:0] pio_state_s1_readdata,                                                    //                                                                   .readdata
	...
	wire   [31:0] pio_row_s1_agent_m0_readdata;                                                        // pio_row_s1_translator:uav_readdata -> pio_row_s1_agent:m0_readdata
	wire          pio_row_s1_agent_m0_waitrequest;                                                     // pio_row_s1_translator:uav_waitrequest -> pio_row_s1_agent:m0_waitrequest
	wire          pio_row_s1_agent_m0_debugaccess;                                                     // pio_row_s1_agent:m0_debugaccess -> pio_row_s1_translator:uav_debugaccess
	wire   [20:0] pio_row_s1_agent_m0_address;                                                         // pio_row_s1_agent:m0_address -> pio_row_s1_translator:uav_address
	wire    [3:0] pio_row_s1_agent_m0_byteenable;                                                      // pio_row_s1_agent:m0_byteenable -> pio_row_s1_translator:uav_byteenable
	wire          pio_row_s1_agent_m0_read;                                                            // pio_row_s1_agent:m0_read -> pio_row_s1_translator:uav_read
	wire          pio_row_s1_agent_m0_readdatavalid;                                                   // pio_row_s1_translator:uav_readdatavalid -> pio_row_s1_agent:m0_readdatavalid
	wire          pio_row_s1_agent_m0_lock;                                                            // pio_row_s1_agent:m0_lock -> pio_row_s1_translator:uav_lock
	wire   [31:0] pio_row_s1_agent_m0_writedata;                                                       // pio_row_s1_agent:m0_writedata -> pio_row_s1_translator:uav_writedata
	wire          pio_row_s1_agent_m0_write;                                                           // pio_row_s1_agent:m0_write -> pio_row_s1_translator:uav_write
	wire    [2:0] pio_row_s1_agent_m0_burstcount;                                                      // pio_row_s1_agent:m0_burstcount -> pio_row_s1_translator:uav_burstcount
	wire          pio_row_s1_agent_rf_source_valid;                                                    // pio_row_s1_agent:rf_source_valid -> pio_row_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_row_s1_agent_rf_source_data;                                                     // pio_row_s1_agent:rf_source_data -> pio_row_s1_agent_rsp_fifo:in_data
	wire          pio_row_s1_agent_rf_source_ready;                                                    // pio_row_s1_agent_rsp_fifo:in_ready -> pio_row_s1_agent:rf_source_ready
	wire          pio_row_s1_agent_rf_source_startofpacket;                                            // pio_row_s1_agent:rf_source_startofpacket -> pio_row_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_row_s1_agent_rf_source_endofpacket;                                              // pio_row_s1_agent:rf_source_endofpacket -> pio_row_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_row_s1_agent_rsp_fifo_out_valid;                                                 // pio_row_s1_agent_rsp_fifo:out_valid -> pio_row_s1_agent:rf_sink_valid
	wire  [118:0] pio_row_s1_agent_rsp_fifo_out_data;                                                  // pio_row_s1_agent_rsp_fifo:out_data -> pio_row_s1_agent:rf_sink_data
	wire          pio_row_s1_agent_rsp_fifo_out_ready;                                                 // pio_row_s1_agent:rf_sink_ready -> pio_row_s1_agent_rsp_fifo:out_ready
	wire          pio_row_s1_agent_rsp_fifo_out_startofpacket;                                         // pio_row_s1_agent_rsp_fifo:out_startofpacket -> pio_row_s1_agent:rf_sink_startofpacket
	wire          pio_row_s1_agent_rsp_fifo_out_endofpacket;                                           // pio_row_s1_agent_rsp_fifo:out_endofpacket -> pio_row_s1_agent:rf_sink_endofpacket
	wire          pio_row_s1_agent_rdata_fifo_src_valid;                                               // pio_row_s1_agent:rdata_fifo_src_valid -> pio_row_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_row_s1_agent_rdata_fifo_src_data;                                                // pio_row_s1_agent:rdata_fifo_src_data -> pio_row_s1_agent_rdata_fifo:in_data
	wire          pio_row_s1_agent_rdata_fifo_src_ready;                                               // pio_row_s1_agent_rdata_fifo:in_ready -> pio_row_s1_agent:rdata_fifo_src_ready
	wire   [31:0] pio_col_s1_agent_m0_readdata;                                                        // pio_col_s1_translator:uav_readdata -> pio_col_s1_agent:m0_readdata
	wire          pio_col_s1_agent_m0_waitrequest;                                                     // pio_col_s1_translator:uav_waitrequest -> pio_col_s1_agent:m0_waitrequest
	wire          pio_col_s1_agent_m0_debugaccess;                                                     // pio_col_s1_agent:m0_debugaccess -> pio_col_s1_translator:uav_debugaccess
	wire   [20:0] pio_col_s1_agent_m0_address;                                                         // pio_col_s1_agent:m0_address -> pio_col_s1_translator:uav_address
	wire    [3:0] pio_col_s1_agent_m0_byteenable;                                                      // pio_col_s1_agent:m0_byteenable -> pio_col_s1_translator:uav_byteenable
	wire          pio_col_s1_agent_m0_read;                                                            // pio_col_s1_agent:m0_read -> pio_col_s1_translator:uav_read
	wire          pio_col_s1_agent_m0_readdatavalid;                                                   // pio_col_s1_translator:uav_readdatavalid -> pio_col_s1_agent:m0_readdatavalid
	wire          pio_col_s1_agent_m0_lock;                                                            // pio_col_s1_agent:m0_lock -> pio_col_s1_translator:uav_lock
	wire   [31:0] pio_col_s1_agent_m0_writedata;                                                       // pio_col_s1_agent:m0_writedata -> pio_col_s1_translator:uav_writedata
	wire          pio_col_s1_agent_m0_write;                                                           // pio_col_s1_agent:m0_write -> pio_col_s1_translator:uav_write
	wire    [2:0] pio_col_s1_agent_m0_burstcount;                                                      // pio_col_s1_agent:m0_burstcount -> pio_col_s1_translator:uav_burstcount
	wire          pio_col_s1_agent_rf_source_valid;                                                    // pio_col_s1_agent:rf_source_valid -> pio_col_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_col_s1_agent_rf_source_data;                                                     // pio_col_s1_agent:rf_source_data -> pio_col_s1_agent_rsp_fifo:in_data
	wire          pio_col_s1_agent_rf_source_ready;                                                    // pio_col_s1_agent_rsp_fifo:in_ready -> pio_col_s1_agent:rf_source_ready
	wire          pio_col_s1_agent_rf_source_startofpacket;                                            // pio_col_s1_agent:rf_source_startofpacket -> pio_col_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_col_s1_agent_rf_source_endofpacket;                                              // pio_col_s1_agent:rf_source_endofpacket -> pio_col_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_col_s1_agent_rsp_fifo_out_valid;                                                 // pio_col_s1_agent_rsp_fifo:out_valid -> pio_col_s1_agent:rf_sink_valid
	wire  [118:0] pio_col_s1_agent_rsp_fifo_out_data;                                                  // pio_col_s1_agent_rsp_fifo:out_data -> pio_col_s1_agent:rf_sink_data
	wire          pio_col_s1_agent_rsp_fifo_out_ready;                                                 // pio_col_s1_agent:rf_sink_ready -> pio_col_s1_agent_rsp_fifo:out_ready
	wire          pio_col_s1_agent_rsp_fifo_out_startofpacket;                                         // pio_col_s1_agent_rsp_fifo:out_startofpacket -> pio_col_s1_agent:rf_sink_startofpacket
	wire          pio_col_s1_agent_rsp_fifo_out_endofpacket;                                           // pio_col_s1_agent_rsp_fifo:out_endofpacket -> pio_col_s1_agent:rf_sink_endofpacket
	wire          pio_col_s1_agent_rdata_fifo_src_valid;                                               // pio_col_s1_agent:rdata_fifo_src_valid -> pio_col_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_col_s1_agent_rdata_fifo_src_data;                                                // pio_col_s1_agent:rdata_fifo_src_data -> pio_col_s1_agent_rdata_fifo:in_data
	wire          pio_col_s1_agent_rdata_fifo_src_ready;                                               // pio_col_s1_agent_rdata_fifo:in_ready -> pio_col_s1_agent:rdata_fifo_src_ready
	wire   [31:0] pio_color_s1_agent_m0_readdata;                                                      // pio_color_s1_translator:uav_readdata -> pio_color_s1_agent:m0_readdata
	wire          pio_color_s1_agent_m0_waitrequest;                                                   // pio_color_s1_translator:uav_waitrequest -> pio_color_s1_agent:m0_waitrequest
	wire          pio_color_s1_agent_m0_debugaccess;                                                   // pio_color_s1_agent:m0_debugaccess -> pio_color_s1_translator:uav_debugaccess
	wire   [20:0] pio_color_s1_agent_m0_address;                                                       // pio_color_s1_agent:m0_address -> pio_color_s1_translator:uav_address
	wire    [3:0] pio_color_s1_agent_m0_byteenable;                                                    // pio_color_s1_agent:m0_byteenable -> pio_color_s1_translator:uav_byteenable
	wire          pio_color_s1_agent_m0_read;                                                          // pio_color_s1_agent:m0_read -> pio_color_s1_translator:uav_read
	wire          pio_color_s1_agent_m0_readdatavalid;                                                 // pio_color_s1_translator:uav_readdatavalid -> pio_color_s1_agent:m0_readdatavalid
	wire          pio_color_s1_agent_m0_lock;                                                          // pio_color_s1_agent:m0_lock -> pio_color_s1_translator:uav_lock
	wire   [31:0] pio_color_s1_agent_m0_writedata;                                                     // pio_color_s1_agent:m0_writedata -> pio_color_s1_translator:uav_writedata
	wire          pio_color_s1_agent_m0_write;                                                         // pio_color_s1_agent:m0_write -> pio_color_s1_translator:uav_write
	wire    [2:0] pio_color_s1_agent_m0_burstcount;                                                    // pio_color_s1_agent:m0_burstcount -> pio_color_s1_translator:uav_burstcount
	wire          pio_color_s1_agent_rf_source_valid;                                                  // pio_color_s1_agent:rf_source_valid -> pio_color_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_color_s1_agent_rf_source_data;                                                   // pio_color_s1_agent:rf_source_data -> pio_color_s1_agent_rsp_fifo:in_data
	wire          pio_color_s1_agent_rf_source_ready;                                                  // pio_color_s1_agent_rsp_fifo:in_ready -> pio_color_s1_agent:rf_source_ready
	wire          pio_color_s1_agent_rf_source_startofpacket;                                          // pio_color_s1_agent:rf_source_startofpacket -> pio_color_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_color_s1_agent_rf_source_endofpacket;                                            // pio_color_s1_agent:rf_source_endofpacket -> pio_color_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_color_s1_agent_rsp_fifo_out_valid;                                               // pio_color_s1_agent_rsp_fifo:out_valid -> pio_color_s1_agent:rf_sink_valid
	wire  [118:0] pio_color_s1_agent_rsp_fifo_out_data;                                                // pio_color_s1_agent_rsp_fifo:out_data -> pio_color_s1_agent:rf_sink_data
	wire          pio_color_s1_agent_rsp_fifo_out_ready;                                               // pio_color_s1_agent:rf_sink_ready -> pio_color_s1_agent_rsp_fifo:out_ready
	wire          pio_color_s1_agent_rsp_fifo_out_startofpacket;                                       // pio_color_s1_agent_rsp_fifo:out_startofpacket -> pio_color_s1_agent:rf_sink_startofpacket
	wire          pio_color_s1_agent_rsp_fifo_out_endofpacket;                                         // pio_color_s1_agent_rsp_fifo:out_endofpacket -> pio_color_s1_agent:rf_sink_endofpacket
	wire          pio_color_s1_agent_rdata_fifo_src_valid;                                             // pio_color_s1_agent:rdata_fifo_src_valid -> pio_color_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_color_s1_agent_rdata_fifo_src_data;                                              // pio_color_s1_agent:rdata_fifo_src_data -> pio_color_s1_agent_rdata_fifo:in_data
	wire          pio_color_s1_agent_rdata_fifo_src_ready;                                             // pio_color_s1_agent_rdata_fifo:in_ready -> pio_color_s1_agent:rdata_fifo_src_ready
	wire   [31:0] pio_state_s1_agent_m0_readdata;                                                      // pio_state_s1_translator:uav_readdata -> pio_state_s1_agent:m0_readdata
	wire          pio_state_s1_agent_m0_waitrequest;                                                   // pio_state_s1_translator:uav_waitrequest -> pio_state_s1_agent:m0_waitrequest
	wire          pio_state_s1_agent_m0_debugaccess;                                                   // pio_state_s1_agent:m0_debugaccess -> pio_state_s1_translator:uav_debugaccess
	wire   [20:0] pio_state_s1_agent_m0_address;                                                       // pio_state_s1_agent:m0_address -> pio_state_s1_translator:uav_address
	wire    [3:0] pio_state_s1_agent_m0_byteenable;                                                    // pio_state_s1_agent:m0_byteenable -> pio_state_s1_translator:uav_byteenable
	wire          pio_state_s1_agent_m0_read;                                                          // pio_state_s1_agent:m0_read -> pio_state_s1_translator:uav_read
	wire          pio_state_s1_agent_m0_readdatavalid;                                                 // pio_state_s1_translator:uav_readdatavalid -> pio_state_s1_agent:m0_readdatavalid
	wire          pio_state_s1_agent_m0_lock;                                                          // pio_state_s1_agent:m0_lock -> pio_state_s1_translator:uav_lock
	wire   [31:0] pio_state_s1_agent_m0_writedata;                                                     // pio_state_s1_agent:m0_writedata -> pio_state_s1_translator:uav_writedata
	wire          pio_state_s1_agent_m0_write;                                                         // pio_state_s1_agent:m0_write -> pio_state_s1_translator:uav_write
	wire    [2:0] pio_state_s1_agent_m0_burstcount;                                                    // pio_state_s1_agent:m0_burstcount -> pio_state_s1_translator:uav_burstcount
	wire          pio_state_s1_agent_rf_source_valid;                                                  // pio_state_s1_agent:rf_source_valid -> pio_state_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_state_s1_agent_rf_source_data;                                                   // pio_state_s1_agent:rf_source_data -> pio_state_s1_agent_rsp_fifo:in_data
	wire          pio_state_s1_agent_rf_source_ready;                                                  // pio_state_s1_agent_rsp_fifo:in_ready -> pio_state_s1_agent:rf_source_ready
	wire          pio_state_s1_agent_rf_source_startofpacket;                                          // pio_state_s1_agent:rf_source_startofpacket -> pio_state_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_state_s1_agent_rf_source_endofpacket;                                            // pio_state_s1_agent:rf_source_endofpacket -> pio_state_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_state_s1_agent_rsp_fifo_out_valid;                                               // pio_state_s1_agent_rsp_fifo:out_valid -> pio_state_s1_agent:rf_sink_valid
	wire  [118:0] pio_state_s1_agent_rsp_fifo_out_data;                                                // pio_state_s1_agent_rsp_fifo:out_data -> pio_state_s1_agent:rf_sink_data
	wire          pio_state_s1_agent_rsp_fifo_out_ready;                                               // pio_state_s1_agent:rf_sink_ready -> pio_state_s1_agent_rsp_fifo:out_ready
	wire          pio_state_s1_agent_rsp_fifo_out_startofpacket;                                       // pio_state_s1_agent_rsp_fifo:out_startofpacket -> pio_state_s1_agent:rf_sink_startofpacket
	wire          pio_state_s1_agent_rsp_fifo_out_endofpacket;                                         // pio_state_s1_agent_rsp_fifo:out_endofpacket -> pio_state_s1_agent:rf_sink_endofpacket
	wire          pio_state_s1_agent_rdata_fifo_src_valid;                                             // pio_state_s1_agent:rdata_fifo_src_valid -> pio_state_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_state_s1_agent_rdata_fifo_src_data;                                              // pio_state_s1_agent:rdata_fifo_src_data -> pio_state_s1_agent_rdata_fifo:in_data
	wire          pio_state_s1_agent_rdata_fifo_src_ready;                                             // pio_state_s1_agent_rdata_fifo:in_ready -> pio_state_s1_agent:rdata_fifo_src_ready
	wire   [31:0] pio_collectsingle_s1_agent_m0_readdata;                                              // pio_collectsingle_s1_translator:uav_readdata -> pio_collectsingle_s1_agent:m0_readdata
	wire          pio_collectsingle_s1_agent_m0_waitrequest;                                           // pio_collectsingle_s1_translator:uav_waitrequest -> pio_collectsingle_s1_agent:m0_waitrequest
	wire          pio_collectsingle_s1_agent_m0_debugaccess;                                           // pio_collectsingle_s1_agent:m0_debugaccess -> pio_collectsingle_s1_translator:uav_debugaccess
	wire   [20:0] pio_collectsingle_s1_agent_m0_address;                                               // pio_collectsingle_s1_agent:m0_address -> pio_collectsingle_s1_translator:uav_address
	wire    [3:0] pio_collectsingle_s1_agent_m0_byteenable;                                            // pio_collectsingle_s1_agent:m0_byteenable -> pio_collectsingle_s1_translator:uav_byteenable
	wire          pio_collectsingle_s1_agent_m0_read;                                                  // pio_collectsingle_s1_agent:m0_read -> pio_collectsingle_s1_translator:uav_read
	wire          pio_collectsingle_s1_agent_m0_readdatavalid;                                         // pio_collectsingle_s1_translator:uav_readdatavalid -> pio_collectsingle_s1_agent:m0_readdatavalid
	wire          pio_collectsingle_s1_agent_m0_lock;                                                  // pio_collectsingle_s1_agent:m0_lock -> pio_collectsingle_s1_translator:uav_lock
	wire   [31:0] pio_collectsingle_s1_agent_m0_writedata;                                             // pio_collectsingle_s1_agent:m0_writedata -> pio_collectsingle_s1_translator:uav_writedata
	wire          pio_collectsingle_s1_agent_m0_write;                                                 // pio_collectsingle_s1_agent:m0_write -> pio_collectsingle_s1_translator:uav_write
	wire    [2:0] pio_collectsingle_s1_agent_m0_burstcount;                                            // pio_collectsingle_s1_agent:m0_burstcount -> pio_collectsingle_s1_translator:uav_burstcount
	wire          pio_collectsingle_s1_agent_rf_source_valid;                                          // pio_collectsingle_s1_agent:rf_source_valid -> pio_collectsingle_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_collectsingle_s1_agent_rf_source_data;                                           // pio_collectsingle_s1_agent:rf_source_data -> pio_collectsingle_s1_agent_rsp_fifo:in_data
	wire          pio_collectsingle_s1_agent_rf_source_ready;                                          // pio_collectsingle_s1_agent_rsp_fifo:in_ready -> pio_collectsingle_s1_agent:rf_source_ready
	wire          pio_collectsingle_s1_agent_rf_source_startofpacket;                                  // pio_collectsingle_s1_agent:rf_source_startofpacket -> pio_collectsingle_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_collectsingle_s1_agent_rf_source_endofpacket;                                    // pio_collectsingle_s1_agent:rf_source_endofpacket -> pio_collectsingle_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_collectsingle_s1_agent_rsp_fifo_out_valid;                                       // pio_collectsingle_s1_agent_rsp_fifo:out_valid -> pio_collectsingle_s1_agent:rf_sink_valid
	wire  [118:0] pio_collectsingle_s1_agent_rsp_fifo_out_data;                                        // pio_collectsingle_s1_agent_rsp_fifo:out_data -> pio_collectsingle_s1_agent:rf_sink_data
	wire          pio_collectsingle_s1_agent_rsp_fifo_out_ready;                                       // pio_collectsingle_s1_agent:rf_sink_ready -> pio_collectsingle_s1_agent_rsp_fifo:out_ready
	wire          pio_collectsingle_s1_agent_rsp_fifo_out_startofpacket;                               // pio_collectsingle_s1_agent_rsp_fifo:out_startofpacket -> pio_collectsingle_s1_agent:rf_sink_startofpacket
	wire          pio_collectsingle_s1_agent_rsp_fifo_out_endofpacket;                                 // pio_collectsingle_s1_agent_rsp_fifo:out_endofpacket -> pio_collectsingle_s1_agent:rf_sink_endofpacket
	wire          pio_collectsingle_s1_agent_rdata_fifo_src_valid;                                     // pio_collectsingle_s1_agent:rdata_fifo_src_valid -> pio_collectsingle_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_collectsingle_s1_agent_rdata_fifo_src_data;                                      // pio_collectsingle_s1_agent:rdata_fifo_src_data -> pio_collectsingle_s1_agent_rdata_fifo:in_data
	wire          pio_collectsingle_s1_agent_rdata_fifo_src_ready;                                     // pio_collectsingle_s1_agent_rdata_fifo:in_ready -> pio_collectsingle_s1_agent:rdata_fifo_src_ready
	wire   [31:0] pio_integral_data_s1_agent_m0_readdata;                                              // pio_integral_data_s1_translator:uav_readdata -> pio_integral_data_s1_agent:m0_readdata
	wire          pio_integral_data_s1_agent_m0_waitrequest;                                           // pio_integral_data_s1_translator:uav_waitrequest -> pio_integral_data_s1_agent:m0_waitrequest
	wire          pio_integral_data_s1_agent_m0_debugaccess;                                           // pio_integral_data_s1_agent:m0_debugaccess -> pio_integral_data_s1_translator:uav_debugaccess
	wire   [20:0] pio_integral_data_s1_agent_m0_address;                                               // pio_integral_data_s1_agent:m0_address -> pio_integral_data_s1_translator:uav_address
	wire    [3:0] pio_integral_data_s1_agent_m0_byteenable;                                            // pio_integral_data_s1_agent:m0_byteenable -> pio_integral_data_s1_translator:uav_byteenable
	wire          pio_integral_data_s1_agent_m0_read;                                                  // pio_integral_data_s1_agent:m0_read -> pio_integral_data_s1_translator:uav_read
	wire          pio_integral_data_s1_agent_m0_readdatavalid;                                         // pio_integral_data_s1_translator:uav_readdatavalid -> pio_integral_data_s1_agent:m0_readdatavalid
	wire          pio_integral_data_s1_agent_m0_lock;                                                  // pio_integral_data_s1_agent:m0_lock -> pio_integral_data_s1_translator:uav_lock
	wire   [31:0] pio_integral_data_s1_agent_m0_writedata;                                             // pio_integral_data_s1_agent:m0_writedata -> pio_integral_data_s1_translator:uav_writedata
	wire          pio_integral_data_s1_agent_m0_write;                                                 // pio_integral_data_s1_agent:m0_write -> pio_integral_data_s1_translator:uav_write
	wire    [2:0] pio_integral_data_s1_agent_m0_burstcount;                                            // pio_integral_data_s1_agent:m0_burstcount -> pio_integral_data_s1_translator:uav_burstcount
	wire          pio_integral_data_s1_agent_rf_source_valid;                                          // pio_integral_data_s1_agent:rf_source_valid -> pio_integral_data_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pio_integral_data_s1_agent_rf_source_data;                                           // pio_integral_data_s1_agent:rf_source_data -> pio_integral_data_s1_agent_rsp_fifo:in_data
	wire          pio_integral_data_s1_agent_rf_source_ready;                                          // pio_integral_data_s1_agent_rsp_fifo:in_ready -> pio_integral_data_s1_agent:rf_source_ready
	wire          pio_integral_data_s1_agent_rf_source_startofpacket;                                  // pio_integral_data_s1_agent:rf_source_startofpacket -> pio_integral_data_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_integral_data_s1_agent_rf_source_endofpacket;                                    // pio_integral_data_s1_agent:rf_source_endofpacket -> pio_integral_data_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_integral_data_s1_agent_rsp_fifo_out_valid;                                       // pio_integral_data_s1_agent_rsp_fifo:out_valid -> pio_integral_data_s1_agent:rf_sink_valid
	wire  [118:0] pio_integral_data_s1_agent_rsp_fifo_out_data;                                        // pio_integral_data_s1_agent_rsp_fifo:out_data -> pio_integral_data_s1_agent:rf_sink_data
	wire          pio_integral_data_s1_agent_rsp_fifo_out_ready;                                       // pio_integral_data_s1_agent:rf_sink_ready -> pio_integral_data_s1_agent_rsp_fifo:out_ready
	wire          pio_integral_data_s1_agent_rsp_fifo_out_startofpacket;                               // pio_integral_data_s1_agent_rsp_fifo:out_startofpacket -> pio_integral_data_s1_agent:rf_sink_startofpacket
	wire          pio_integral_data_s1_agent_rsp_fifo_out_endofpacket;                                 // pio_integral_data_s1_agent_rsp_fifo:out_endofpacket -> pio_integral_data_s1_agent:rf_sink_endofpacket
	wire          pio_integral_data_s1_agent_rdata_fifo_src_valid;                                     // pio_integral_data_s1_agent:rdata_fifo_src_valid -> pio_integral_data_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_integral_data_s1_agent_rdata_fifo_src_data;                                      // pio_integral_data_s1_agent:rdata_fifo_src_data -> pio_integral_data_s1_agent_rdata_fifo:in_data
	wire          pio_integral_data_s1_agent_rdata_fifo_src_ready;                                     // pio_integral_data_s1_agent_rdata_fifo:in_ready -> pio_integral_data_s1_agent:rdata_fifo_src_ready
	...
	wire          pio_row_s1_agent_rp_valid;                                                           // pio_row_s1_agent:rp_valid -> router_005:sink_valid
	wire  [117:0] pio_row_s1_agent_rp_data;                                                            // pio_row_s1_agent:rp_data -> router_005:sink_data
	wire          pio_row_s1_agent_rp_ready;                                                           // router_005:sink_ready -> pio_row_s1_agent:rp_ready
	wire          pio_row_s1_agent_rp_startofpacket;                                                   // pio_row_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          pio_row_s1_agent_rp_endofpacket;                                                     // pio_row_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          pio_col_s1_agent_rp_valid;                                                           // pio_col_s1_agent:rp_valid -> router_006:sink_valid
	wire  [117:0] pio_col_s1_agent_rp_data;                                                            // pio_col_s1_agent:rp_data -> router_006:sink_data
	wire          pio_col_s1_agent_rp_ready;                                                           // router_006:sink_ready -> pio_col_s1_agent:rp_ready
	wire          pio_col_s1_agent_rp_startofpacket;                                                   // pio_col_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          pio_col_s1_agent_rp_endofpacket;                                                     // pio_col_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          pio_color_s1_agent_rp_valid;                                                         // pio_color_s1_agent:rp_valid -> router_007:sink_valid
	wire  [117:0] pio_color_s1_agent_rp_data;                                                          // pio_color_s1_agent:rp_data -> router_007:sink_data
	wire          pio_color_s1_agent_rp_ready;                                                         // router_007:sink_ready -> pio_color_s1_agent:rp_ready
	wire          pio_color_s1_agent_rp_startofpacket;                                                 // pio_color_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          pio_color_s1_agent_rp_endofpacket;                                                   // pio_color_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          pio_state_s1_agent_rp_valid;                                                         // pio_state_s1_agent:rp_valid -> router_008:sink_valid
	wire  [117:0] pio_state_s1_agent_rp_data;                                                          // pio_state_s1_agent:rp_data -> router_008:sink_data
	wire          pio_state_s1_agent_rp_ready;                                                         // router_008:sink_ready -> pio_state_s1_agent:rp_ready
	wire          pio_state_s1_agent_rp_startofpacket;                                                 // pio_state_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          pio_state_s1_agent_rp_endofpacket;                                                   // pio_state_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          pio_collectsingle_s1_agent_rp_valid;                                                 // pio_collectsingle_s1_agent:rp_valid -> router_009:sink_valid
	wire  [117:0] pio_collectsingle_s1_agent_rp_data;                                                  // pio_collectsingle_s1_agent:rp_data -> router_009:sink_data
	wire          pio_collectsingle_s1_agent_rp_ready;                                                 // router_009:sink_ready -> pio_collectsingle_s1_agent:rp_ready
	wire          pio_collectsingle_s1_agent_rp_startofpacket;                                         // pio_collectsingle_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          pio_collectsingle_s1_agent_rp_endofpacket;                                           // pio_collectsingle_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          pio_integral_data_s1_agent_rp_valid;                                                 // pio_integral_data_s1_agent:rp_valid -> router_010:sink_valid
	wire  [117:0] pio_integral_data_s1_agent_rp_data;                                                  // pio_integral_data_s1_agent:rp_data -> router_010:sink_data
	wire          pio_integral_data_s1_agent_rp_ready;                                                 // router_010:sink_ready -> pio_integral_data_s1_agent:rp_ready
	wire          pio_integral_data_s1_agent_rp_startofpacket;                                         // pio_integral_data_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          pio_integral_data_s1_agent_rp_endofpacket;                                           // pio_integral_data_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                               // cmd_mux_003:src_valid -> pio_row_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_003_src_data;                                                                // cmd_mux_003:src_data -> pio_row_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                               // pio_row_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire   [10:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> pio_row_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                                       // cmd_mux_003:src_startofpacket -> pio_row_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                         // cmd_mux_003:src_endofpacket -> pio_row_s1_burst_adapter:sink0_endofpacket
	wire          pio_row_s1_burst_adapter_source0_valid;                                              // pio_row_s1_burst_adapter:source0_valid -> pio_row_s1_agent:cp_valid
	wire  [117:0] pio_row_s1_burst_adapter_source0_data;                                               // pio_row_s1_burst_adapter:source0_data -> pio_row_s1_agent:cp_data
	wire          pio_row_s1_burst_adapter_source0_ready;                                              // pio_row_s1_agent:cp_ready -> pio_row_s1_burst_adapter:source0_ready
	wire   [10:0] pio_row_s1_burst_adapter_source0_channel;                                            // pio_row_s1_burst_adapter:source0_channel -> pio_row_s1_agent:cp_channel
	wire          pio_row_s1_burst_adapter_source0_startofpacket;                                      // pio_row_s1_burst_adapter:source0_startofpacket -> pio_row_s1_agent:cp_startofpacket
	wire          pio_row_s1_burst_adapter_source0_endofpacket;                                        // pio_row_s1_burst_adapter:source0_endofpacket -> pio_row_s1_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                                               // cmd_mux_004:src_valid -> pio_col_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_004_src_data;                                                                // cmd_mux_004:src_data -> pio_col_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                               // pio_col_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire   [10:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> pio_col_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                       // cmd_mux_004:src_startofpacket -> pio_col_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                         // cmd_mux_004:src_endofpacket -> pio_col_s1_burst_adapter:sink0_endofpacket
	wire          pio_col_s1_burst_adapter_source0_valid;                                              // pio_col_s1_burst_adapter:source0_valid -> pio_col_s1_agent:cp_valid
	wire  [117:0] pio_col_s1_burst_adapter_source0_data;                                               // pio_col_s1_burst_adapter:source0_data -> pio_col_s1_agent:cp_data
	wire          pio_col_s1_burst_adapter_source0_ready;                                              // pio_col_s1_agent:cp_ready -> pio_col_s1_burst_adapter:source0_ready
	wire   [10:0] pio_col_s1_burst_adapter_source0_channel;                                            // pio_col_s1_burst_adapter:source0_channel -> pio_col_s1_agent:cp_channel
	wire          pio_col_s1_burst_adapter_source0_startofpacket;                                      // pio_col_s1_burst_adapter:source0_startofpacket -> pio_col_s1_agent:cp_startofpacket
	wire          pio_col_s1_burst_adapter_source0_endofpacket;                                        // pio_col_s1_burst_adapter:source0_endofpacket -> pio_col_s1_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                               // cmd_mux_005:src_valid -> pio_color_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_005_src_data;                                                                // cmd_mux_005:src_data -> pio_color_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                               // pio_color_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire   [10:0] cmd_mux_005_src_channel;                                                             // cmd_mux_005:src_channel -> pio_color_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                       // cmd_mux_005:src_startofpacket -> pio_color_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                         // cmd_mux_005:src_endofpacket -> pio_color_s1_burst_adapter:sink0_endofpacket
	wire          pio_color_s1_burst_adapter_source0_valid;                                            // pio_color_s1_burst_adapter:source0_valid -> pio_color_s1_agent:cp_valid
	wire  [117:0] pio_color_s1_burst_adapter_source0_data;                                             // pio_color_s1_burst_adapter:source0_data -> pio_color_s1_agent:cp_data
	wire          pio_color_s1_burst_adapter_source0_ready;                                            // pio_color_s1_agent:cp_ready -> pio_color_s1_burst_adapter:source0_ready
	wire   [10:0] pio_color_s1_burst_adapter_source0_channel;                                          // pio_color_s1_burst_adapter:source0_channel -> pio_color_s1_agent:cp_channel
	wire          pio_color_s1_burst_adapter_source0_startofpacket;                                    // pio_color_s1_burst_adapter:source0_startofpacket -> pio_color_s1_agent:cp_startofpacket
	wire          pio_color_s1_burst_adapter_source0_endofpacket;                                      // pio_color_s1_burst_adapter:source0_endofpacket -> pio_color_s1_agent:cp_endofpacket
	wire          cmd_mux_006_src_valid;                                                               // cmd_mux_006:src_valid -> pio_state_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_006_src_data;                                                                // cmd_mux_006:src_data -> pio_state_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                               // pio_state_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire   [10:0] cmd_mux_006_src_channel;                                                             // cmd_mux_006:src_channel -> pio_state_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                       // cmd_mux_006:src_startofpacket -> pio_state_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                         // cmd_mux_006:src_endofpacket -> pio_state_s1_burst_adapter:sink0_endofpacket
	wire          pio_state_s1_burst_adapter_source0_valid;                                            // pio_state_s1_burst_adapter:source0_valid -> pio_state_s1_agent:cp_valid
	wire  [117:0] pio_state_s1_burst_adapter_source0_data;                                             // pio_state_s1_burst_adapter:source0_data -> pio_state_s1_agent:cp_data
	wire          pio_state_s1_burst_adapter_source0_ready;                                            // pio_state_s1_agent:cp_ready -> pio_state_s1_burst_adapter:source0_ready
	wire   [10:0] pio_state_s1_burst_adapter_source0_channel;                                          // pio_state_s1_burst_adapter:source0_channel -> pio_state_s1_agent:cp_channel
	wire          pio_state_s1_burst_adapter_source0_startofpacket;                                    // pio_state_s1_burst_adapter:source0_startofpacket -> pio_state_s1_agent:cp_startofpacket
	wire          pio_state_s1_burst_adapter_source0_endofpacket;                                      // pio_state_s1_burst_adapter:source0_endofpacket -> pio_state_s1_agent:cp_endofpacket
	wire          cmd_mux_007_src_valid;                                                               // cmd_mux_007:src_valid -> pio_collectsingle_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_007_src_data;                                                                // cmd_mux_007:src_data -> pio_collectsingle_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                               // pio_collectsingle_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire   [10:0] cmd_mux_007_src_channel;                                                             // cmd_mux_007:src_channel -> pio_collectsingle_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                       // cmd_mux_007:src_startofpacket -> pio_collectsingle_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                         // cmd_mux_007:src_endofpacket -> pio_collectsingle_s1_burst_adapter:sink0_endofpacket
	wire          pio_collectsingle_s1_burst_adapter_source0_valid;                                    // pio_collectsingle_s1_burst_adapter:source0_valid -> pio_collectsingle_s1_agent:cp_valid
	wire  [117:0] pio_collectsingle_s1_burst_adapter_source0_data;                                     // pio_collectsingle_s1_burst_adapter:source0_data -> pio_collectsingle_s1_agent:cp_data
	wire          pio_collectsingle_s1_burst_adapter_source0_ready;                                    // pio_collectsingle_s1_agent:cp_ready -> pio_collectsingle_s1_burst_adapter:source0_ready
	wire   [10:0] pio_collectsingle_s1_burst_adapter_source0_channel;                                  // pio_collectsingle_s1_burst_adapter:source0_channel -> pio_collectsingle_s1_agent:cp_channel
	wire          pio_collectsingle_s1_burst_adapter_source0_startofpacket;                            // pio_collectsingle_s1_burst_adapter:source0_startofpacket -> pio_collectsingle_s1_agent:cp_startofpacket
	wire          pio_collectsingle_s1_burst_adapter_source0_endofpacket;                              // pio_collectsingle_s1_burst_adapter:source0_endofpacket -> pio_collectsingle_s1_agent:cp_endofpacket
	wire          cmd_mux_008_src_valid;                                                               // cmd_mux_008:src_valid -> pio_integral_data_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                                // cmd_mux_008:src_data -> pio_integral_data_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                               // pio_integral_data_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire   [10:0] cmd_mux_008_src_channel;                                                             // cmd_mux_008:src_channel -> pio_integral_data_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                       // cmd_mux_008:src_startofpacket -> pio_integral_data_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                         // cmd_mux_008:src_endofpacket -> pio_integral_data_s1_burst_adapter:sink0_endofpacket
	wire          pio_integral_data_s1_burst_adapter_source0_valid;                                    // pio_integral_data_s1_burst_adapter:source0_valid -> pio_integral_data_s1_agent:cp_valid
	wire  [117:0] pio_integral_data_s1_burst_adapter_source0_data;                                     // pio_integral_data_s1_burst_adapter:source0_data -> pio_integral_data_s1_agent:cp_data
	wire          pio_integral_data_s1_burst_adapter_source0_ready;                                    // pio_integral_data_s1_agent:cp_ready -> pio_integral_data_s1_burst_adapter:source0_ready
	wire   [10:0] pio_integral_data_s1_burst_adapter_source0_channel;                                  // pio_integral_data_s1_burst_adapter:source0_channel -> pio_integral_data_s1_agent:cp_channel
	wire          pio_integral_data_s1_burst_adapter_source0_startofpacket;                            // pio_integral_data_s1_burst_adapter:source0_startofpacket -> pio_integral_data_s1_agent:cp_startofpacket
	wire          pio_integral_data_s1_burst_adapter_source0_endofpacket;                              // pio_integral_data_s1_burst_adapter:source0_endofpacket -> pio_integral_data_s1_agent:cp_endofpacket
	...
	wire          pio_row_s1_agent_rdata_fifo_out_valid;                                               // pio_row_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] pio_row_s1_agent_rdata_fifo_out_data;                                                // pio_row_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          pio_row_s1_agent_rdata_fifo_out_ready;                                               // avalon_st_adapter_003:in_0_ready -> pio_row_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                   // avalon_st_adapter_003:out_0_valid -> pio_row_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                    // avalon_st_adapter_003:out_0_data -> pio_row_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                   // pio_row_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                   // avalon_st_adapter_003:out_0_error -> pio_row_s1_agent:rdata_fifo_sink_error
	wire          pio_col_s1_agent_rdata_fifo_out_valid;                                               // pio_col_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] pio_col_s1_agent_rdata_fifo_out_data;                                                // pio_col_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          pio_col_s1_agent_rdata_fifo_out_ready;                                               // avalon_st_adapter_004:in_0_ready -> pio_col_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                   // avalon_st_adapter_004:out_0_valid -> pio_col_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                    // avalon_st_adapter_004:out_0_data -> pio_col_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                   // pio_col_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                   // avalon_st_adapter_004:out_0_error -> pio_col_s1_agent:rdata_fifo_sink_error
	wire          pio_color_s1_agent_rdata_fifo_out_valid;                                             // pio_color_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] pio_color_s1_agent_rdata_fifo_out_data;                                              // pio_color_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          pio_color_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_005:in_0_ready -> pio_color_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                   // avalon_st_adapter_005:out_0_valid -> pio_color_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                    // avalon_st_adapter_005:out_0_data -> pio_color_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                   // pio_color_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                   // avalon_st_adapter_005:out_0_error -> pio_color_s1_agent:rdata_fifo_sink_error
	wire          pio_state_s1_agent_rdata_fifo_out_valid;                                             // pio_state_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_state_s1_agent_rdata_fifo_out_data;                                              // pio_state_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          pio_state_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_006:in_0_ready -> pio_state_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                   // avalon_st_adapter_006:out_0_valid -> pio_state_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                    // avalon_st_adapter_006:out_0_data -> pio_state_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                   // pio_state_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                   // avalon_st_adapter_006:out_0_error -> pio_state_s1_agent:rdata_fifo_sink_error
	wire          pio_collectsingle_s1_agent_rdata_fifo_out_valid;                                     // pio_collectsingle_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] pio_collectsingle_s1_agent_rdata_fifo_out_data;                                      // pio_collectsingle_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          pio_collectsingle_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_007:in_0_ready -> pio_collectsingle_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                   // avalon_st_adapter_007:out_0_valid -> pio_collectsingle_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                    // avalon_st_adapter_007:out_0_data -> pio_collectsingle_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                   // pio_collectsingle_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                   // avalon_st_adapter_007:out_0_error -> pio_collectsingle_s1_agent:rdata_fifo_sink_error
	wire          pio_integral_data_s1_agent_rdata_fifo_out_valid;                                     // pio_integral_data_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] pio_integral_data_s1_agent_rdata_fifo_out_data;                                      // pio_integral_data_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          pio_integral_data_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_008:in_0_ready -> pio_integral_data_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                   // avalon_st_adapter_008:out_0_valid -> pio_integral_data_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                    // avalon_st_adapter_008:out_0_data -> pio_integral_data_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                   // pio_integral_data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                   // avalon_st_adapter_008:out_0_error -> pio_integral_data_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_row_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_row_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (pio_row_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (pio_row_s1_agent_m0_read),                    //                         .read
		.uav_write              (pio_row_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (pio_row_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (pio_row_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (pio_row_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (pio_row_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (pio_row_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (pio_row_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (pio_row_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (pio_row_s1_address),                          //      avalon_anti_slave_0.address
		.av_readdata            (pio_row_s1_readdata),                         //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_col_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_col_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (pio_col_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (pio_col_s1_agent_m0_read),                    //                         .read
		.uav_write              (pio_col_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (pio_col_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (pio_col_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (pio_col_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (pio_col_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (pio_col_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (pio_col_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (pio_col_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (pio_col_s1_address),                          //      avalon_anti_slave_0.address
		.av_readdata            (pio_col_s1_readdata),                         //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_color_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_color_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (pio_color_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (pio_color_s1_agent_m0_read),                  //                         .read
		.uav_write              (pio_color_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (pio_color_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (pio_color_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (pio_color_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (pio_color_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (pio_color_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (pio_color_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (pio_color_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (pio_color_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (pio_color_s1_readdata),                       //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_state_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_state_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (pio_state_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (pio_state_s1_agent_m0_read),                  //                         .read
		.uav_write              (pio_state_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (pio_state_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (pio_state_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (pio_state_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (pio_state_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (pio_state_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (pio_state_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (pio_state_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (pio_state_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (pio_state_s1_readdata),                       //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_collectsingle_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_collectsingle_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (pio_collectsingle_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (pio_collectsingle_s1_agent_m0_read),          //                         .read
		.uav_write              (pio_collectsingle_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (pio_collectsingle_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (pio_collectsingle_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (pio_collectsingle_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (pio_collectsingle_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (pio_collectsingle_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (pio_collectsingle_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (pio_collectsingle_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (pio_collectsingle_s1_address),                //      avalon_anti_slave_0.address
		.av_readdata            (pio_collectsingle_s1_readdata),               //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pio_integral_data_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_integral_data_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (pio_integral_data_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (pio_integral_data_s1_agent_m0_read),          //                         .read
		.uav_write              (pio_integral_data_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (pio_integral_data_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (pio_integral_data_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (pio_integral_data_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (pio_integral_data_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (pio_integral_data_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (pio_integral_data_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (pio_integral_data_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (pio_integral_data_s1_address),                //      avalon_anti_slave_0.address
		.av_readdata            (pio_integral_data_s1_readdata),               //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                         //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (pio_row_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_row_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_row_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_row_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_row_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_row_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_row_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_row_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_row_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_row_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_row_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_row_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_row_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_row_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_row_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_row_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_row_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_row_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_row_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_row_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_row_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_row_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_row_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_row_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_row_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_row_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_row_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_row_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_row_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_row_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_row_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_row_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),              //                .error
		.rdata_fifo_src_ready    (pio_row_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_row_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_row_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_row_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_row_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_row_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_row_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_row_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_row_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_row_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_row_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_row_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_row_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_row_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_row_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_row_s1_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (pio_row_s1_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (pio_row_s1_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (pio_row_s1_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (pio_row_s1_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (pio_row_s1_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                         //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (pio_col_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_col_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_col_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_col_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_col_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_col_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_col_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_col_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_col_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_col_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_col_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_col_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_col_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_col_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_col_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_col_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_col_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_col_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_col_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_col_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_col_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_col_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_col_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_col_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_col_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_col_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_col_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_col_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_col_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_col_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_col_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_col_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (pio_col_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_col_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_col_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_col_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_col_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_col_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_col_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_col_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_col_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_col_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_col_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_col_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_col_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_col_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_col_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_col_s1_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (pio_col_s1_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (pio_col_s1_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (pio_col_s1_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (pio_col_s1_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (pio_col_s1_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                           //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (pio_color_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_color_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_color_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_color_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_color_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_color_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_color_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_color_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_color_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_color_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_color_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_color_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_color_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_color_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_color_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_color_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_color_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_color_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_color_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_color_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_color_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_color_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_color_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_color_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_color_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_color_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_color_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_color_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_color_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_color_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_color_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_color_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (pio_color_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_color_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_color_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_color_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                        //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (pio_color_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_color_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_color_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_color_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_color_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_color_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_color_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_color_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_color_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_color_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_color_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_color_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (pio_color_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (pio_color_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (pio_color_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (pio_color_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (pio_color_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                           //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (pio_state_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_state_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_state_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_state_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_state_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_state_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_state_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_state_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_state_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_state_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_state_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_state_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_state_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_state_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_state_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_state_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_state_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_state_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_state_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_state_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_state_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_state_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_state_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_state_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_state_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_state_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_state_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_state_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_state_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_state_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_state_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_state_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                //                .error
		.rdata_fifo_src_ready    (pio_state_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_state_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_state_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_state_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                        //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (pio_state_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_state_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_state_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_state_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_state_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_state_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_state_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_state_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_state_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_state_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_state_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_state_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (pio_state_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (pio_state_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (pio_state_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (pio_state_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (pio_state_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pio_collectsingle_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                                   //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),              //       clk_reset.reset
		.m0_address              (pio_collectsingle_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_collectsingle_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_collectsingle_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_collectsingle_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_collectsingle_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_collectsingle_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_collectsingle_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_collectsingle_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_collectsingle_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_collectsingle_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_collectsingle_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_collectsingle_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_collectsingle_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_collectsingle_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_collectsingle_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_collectsingle_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_collectsingle_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_collectsingle_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_collectsingle_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_collectsingle_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_collectsingle_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_collectsingle_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_collectsingle_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_collectsingle_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_collectsingle_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_collectsingle_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_collectsingle_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_collectsingle_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_collectsingle_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_collectsingle_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_collectsingle_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_collectsingle_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (pio_collectsingle_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_collectsingle_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_collectsingle_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_collectsingle_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.in_data           (pio_collectsingle_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_collectsingle_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_collectsingle_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_collectsingle_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_collectsingle_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_collectsingle_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_collectsingle_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_collectsingle_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_collectsingle_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_collectsingle_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_collectsingle_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                          //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (pio_collectsingle_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (pio_collectsingle_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (pio_collectsingle_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (pio_collectsingle_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (pio_collectsingle_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (pio_collectsingle_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pio_integral_data_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                                   //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),              //       clk_reset.reset
		.m0_address              (pio_integral_data_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio_integral_data_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio_integral_data_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio_integral_data_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio_integral_data_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio_integral_data_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio_integral_data_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio_integral_data_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio_integral_data_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio_integral_data_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio_integral_data_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio_integral_data_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio_integral_data_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio_integral_data_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio_integral_data_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio_integral_data_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pio_integral_data_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_integral_data_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_integral_data_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_integral_data_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_integral_data_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_integral_data_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pio_integral_data_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio_integral_data_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio_integral_data_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio_integral_data_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio_integral_data_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio_integral_data_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio_integral_data_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio_integral_data_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio_integral_data_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio_integral_data_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (pio_integral_data_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_integral_data_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio_integral_data_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_integral_data_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.in_data           (pio_integral_data_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_integral_data_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_integral_data_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_integral_data_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_integral_data_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_integral_data_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_integral_data_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_integral_data_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_integral_data_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_integral_data_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_integral_data_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                          //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (pio_integral_data_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (pio_integral_data_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (pio_integral_data_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (pio_integral_data_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (pio_integral_data_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (pio_integral_data_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	Computer_System_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (pio_row_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (pio_row_s1_agent_rp_valid),                   //          .valid
		.sink_data          (pio_row_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (pio_row_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (pio_row_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_006 (
		.sink_ready         (pio_col_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (pio_col_s1_agent_rp_valid),                   //          .valid
		.sink_data          (pio_col_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (pio_col_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (pio_col_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_007 (
		.sink_ready         (pio_color_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (pio_color_s1_agent_rp_valid),                 //          .valid
		.sink_data          (pio_color_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (pio_color_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (pio_color_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_008 (
		.sink_ready         (pio_state_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (pio_state_s1_agent_rp_valid),                 //          .valid
		.sink_data          (pio_state_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (pio_state_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (pio_state_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_009 (
		.sink_ready         (pio_collectsingle_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (pio_collectsingle_s1_agent_rp_valid),         //          .valid
		.sink_data          (pio_collectsingle_s1_agent_rp_data),          //          .data
		.sink_startofpacket (pio_collectsingle_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (pio_collectsingle_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_router_002 router_010 (
		.sink_ready         (pio_integral_data_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (pio_integral_data_s1_agent_rp_valid),         //          .valid
		.sink_data          (pio_integral_data_s1_agent_rp_data),          //          .data
		.sink_startofpacket (pio_integral_data_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (pio_integral_data_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_row_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_row_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_row_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_row_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_row_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_row_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_col_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_col_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_col_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_col_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_col_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_col_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_color_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_color_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_color_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_color_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_color_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_color_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_state_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_state_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_state_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_state_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_state_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_state_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) pio_collectsingle_s1_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                   //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),              // cr0_reset.reset
		...
		.source0_valid         (pio_collectsingle_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_collectsingle_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_collectsingle_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_collectsingle_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_collectsingle_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_collectsingle_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) pio_integral_data_s1_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                   //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),              // cr0_reset.reset
		...
		.source0_valid         (pio_integral_data_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_integral_data_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_integral_data_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_integral_data_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_integral_data_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_integral_data_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_row_s1_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (pio_row_s1_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (pio_row_s1_agent_rdata_fifo_out_ready),       //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_col_s1_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (pio_col_s1_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (pio_col_s1_agent_rdata_fifo_out_ready),       //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_color_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (pio_color_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (pio_color_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_state_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (pio_state_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (pio_state_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (pio_collectsingle_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (pio_collectsingle_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (pio_collectsingle_s1_agent_rdata_fifo_out_ready), //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (pio_integral_data_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (pio_integral_data_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (pio_integral_data_s1_agent_rdata_fifo_out_ready), //         .ready
