	Computer_System u0 (
		...
		.pio_col_external_connection_export           (<connected-to-pio_col_external_connection_export>),           //           pio_col_external_connection.export
		.pio_collectsingle_external_connection_export (<connected-to-pio_collectsingle_external_connection_export>), // pio_collectsingle_external_connection.export
		.pio_color_external_connection_export         (<connected-to-pio_color_external_connection_export>),         //         pio_color_external_connection.export
		.pio_row_external_connection_export           (<connected-to-pio_row_external_connection_export>),           //           pio_row_external_connection.export
		.pio_state_external_connection_export         (<connected-to-pio_state_external_connection_export>),         //         pio_state_external_connection.export
		...
		.pio_integral_data_external_connection_export (<connected-to-pio_integral_data_external_connection_export>)  // pio_integral_data_external_connection.export
	);
